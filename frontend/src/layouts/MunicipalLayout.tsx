...
const MunicipalLayout = () => {
  ...
  const navItems = [
    ...
    { to: "/municipal/departments", icon: Building2, label: "Departments" },
    { to: "/municipal/escalations", icon: AlertTriangle, label: "Escalations" },
    { to: "/municipal/reports", icon: FileDown, label: "Reports" },
  ];
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
        <div className="civic-container flex h-16 items-center justify-between">
          <NavLink to="/municipal" className="flex items-center gap-2">
